    ...
    public partial class name_new5 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeritageObjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HeritageObjects_Buildings_BuildingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_HeritageObjects_HeritageObjectId",
                        column: x => x.HeritageObjectId,
                        principalTable: "HeritageObjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
